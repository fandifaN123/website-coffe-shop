		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class=""></i> UNIVERSTAS BUANA PERJUANGAN KARAWANG</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> coffe-paste@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>COFFE-PASTE SI22C</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #ff8680"><b>coffe-Paste SI22C</b></a>
			</div>
